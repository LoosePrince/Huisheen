    ...
    zh: {
        ...
        user: {
            ...
            settings: {
                ...
                subscriptions: '个订阅',
                storageLimit: '存储限制',
                baseStorageLimit: '基础存储限制',
                extraStorageTotal: '额外存储总计',
                emailVerifiedBonus: '邮箱验证奖励',
                serviceProviderBonus: '提供服务奖励',
                serviceProviderBonusWithCount: '提供服务奖励 ({count}个服务)',
                verifyEmailForStorage: '验证您的邮箱可以获得额外 1MB 存储空间，并解锁服务提供奖励',
                provideServiceForStorage: '提供服务可以获得额外存储空间! 每个服务增加 5MB，最多计算 2 个服务',
                totalStorageLimit: '总存储上限',
                betaStorageNotice: '当前为测试阶段，暂不限制存储使用超出情况。正式版本将提供更大的存储空间和管理功能。',
                // 邮箱验证相关
    ...
    en: {
        ...
        user: {
            ...
            settings: {
                ...
                baseStorageLimit: 'Base Storage Limit',
                extraStorageTotal: 'Extra Storage Total',
                emailVerifiedBonus: 'Email Verified Bonus',
                serviceProviderBonus: 'Service Provider Bonus',
                serviceProviderBonusWithCount: 'Service Provider Bonus ({count} service)',
